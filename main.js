...
const targetUrl = 'https://home.nest.com/';

if (process.mas) app.setName('Electron Nest');
...
function createBrowserView() {
  ...
  mainWindow.setBrowserView(nestView);
  ...
  nestView.setAutoResize({
    width: true,
    height: true,
  });

  nestView.webContents.loadURL(targetUrl);

  if (debug) nestView.webContents.openDevTools({ mode: 'right' });
}
  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'Learn More',
          click() { shell.openExternal('https://github.com/rbiggers/electron-nest'); },
        },
        {
          label: 'Documentation',
          click() { shell.openExternal('https://github.com/rbiggers/electron-nest/blob/master/README.md'); },
        },
        {
          label: 'Search Issues',
          click() { shell.openExternal('https://github.com/rbiggers/electron-nest/issues'); },
        },
        {
